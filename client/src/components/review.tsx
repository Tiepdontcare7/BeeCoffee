...
export const Review = () => {
    return (
        <div className="w-[100%] ">
            <div>
                <div className="">
                    <h3 className="text-center text-[#f2b10b] text-4xl mb-4 pt-[50px] uppercase font-bold mx-[5px]">KHÁCH HÀNG NÓI VỀ BEE </h3>
                ...
                <div className="grid sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-5 mt-[50px] mx-[50px] ">
                    <div className="text-center ">
                        <img src="/images/review-001.jpg" alt="" className=" xl:w-[290px] xl:h-[290px] lg:w-[280px] lg:h-[280px] md:w-[270px] md:h-[270px] w-[260px] h-[260px]  mx-auto" />
                    ...
                    <div className="text-center my-[50px] md:mt-0 xl:mt-0">
                        <img src="/images/review-003.webp" alt="" className=" xl:w-[290px] xl:h-[290px] lg:w-[280px] lg:h-[280px] md:w-[270px] md:h-[270px] w-[260px] h-[260px] mx-auto" />
                        <div className="my-[10px]">
                            <i className="fa-solid fa-star text-[#e67e22]"></i>
                            <i className="fa-solid fa-star text-[#e67e22]"></i>
                            <i className="fa-solid fa-star text-[#e67e22]"></i>
                    ...
                    {/* name2 */}
                    <div className="text-center">
                        <img src="/images/review-002.jpg" alt="" className=" xl:w-[290px] xl:h-[290px] lg:w-[280px] lg:h-[280px] md:w-[270px] md:h-[270px] w-[260px] h-[260px] mx-auto" />
                        <div className="my-[10px]">
                            <i className="fa-solid fa-star text-[#e67e22]"></i>
                            <i className="fa-solid fa-star text-[#e67e22]"></i>
                            <i className="fa-solid fa-star text-[#e67e22]"></i>
