            ...
            <div className="pt-[64px]">
                ...
                <div className="grid sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-5 mt-[50px] mx-[50px] ">
                    <div className="text-center ">
                        <img src="/images/review-001.jpg" alt="" className=" xl:w-[250px] xl:h-[250px] lg:w-[240px] lg:h-[240px] md:w-[230px] md:h-[230px] w-[220px] h-[220px] object-cover mx-auto" />
                    ...
                    <div className="text-center my-[50px] md:mt-0 xl:mt-0">
                        <img src="/images/review-003.webp" alt="" className=" xl:w-[250px] xl:h-[250px] lg:w-[240px] lg:h-[240px] md:w-[230px] md:h-[230px]  w-[220px] h-[220px] object-cover mx-auto" />
                        <div className="my-[10px]">
                            <i className="fa-solid fa-star text-[#e67e22]"></i>
                            <i className="fa-solid fa-star text-[#e67e22]"></i>
                            <i className="fa-solid fa-star text-[#e67e22]"></i>
                    ...
                    {/* name2 */}
                    <div className="text-center">
                        <img src="/images/review-002.jpg" alt="" className=" xl:w-[250px] xl:h-[250px] lg:w-[240px] lg:h-[240px] md:w-[230px] md:h-[230px]  w-[220px] h-[220px] object-cover mx-auto" />
                        <div className="my-[10px]">
                            <i className="fa-solid fa-star text-[#e67e22]"></i>
                            <i className="fa-solid fa-star text-[#e67e22]"></i>
                            <i className="fa-solid fa-star text-[#e67e22]"></i>
